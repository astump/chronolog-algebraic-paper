...
\begin{figure}[H]
  ...
  \begin{mathpar}
    ...
    \inferrule[InferCon]{
      ...
      \Gamma \vdash k(\overline{a,}) : \sFunctorApp{D}{Y} \gsep \bigcup_i \mathcal{A}_{a_i} \implies \bigcup_{i} (\mathcal{C}_{a_i} \cup \{ A_i <:: A''_i \})
    }
    ...
    \inferrule[InferApp]{
      \freshTypeMetavariables{A', B}
      \\\\
      \Gamma \vdash f : F \gsep \mathcal{A}_f \implies  \mathcal{C}_f \qquad
    ...
    \inferrule[InferGamma]{
      ...
      \Gamma \vdash \gamma a . \{ \overline{k_i(\overline{x_{ij},}) \mapsto b_i ~ |} \} : B \gsep \mathcal{A}_a \cup \bigcup_i \mathcal{A}_{b_i} \implies \mathcal{C}_a \cup \{ A <:: \sFunctorApp{D}{Y} \} \cup \bigcup_i (\mathcal{C}_{b_i} \cup \{ B_i <:: B \})
    }
