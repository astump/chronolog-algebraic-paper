...
Now that we have formalized subtyping in \lcataSub, we present the coercion typing of \lcata in Figure~\ref{fig:coercion-typing-rules}.
These rules exactly correspond to the algorithmic subtyping rules from Figure~\ref{fig:algorithmic-subtyping-rules}.
This allows us to straightforwardly translate a derivation of $A \subtypeA B$ to a coercion typing derivation $c : A \subtypeA B$ for the sake of inferring the explicit coercions to insert into a term of \lcataSub to result in a valid term of \lcata.
