...
This rule relies upon the coercion typing judgment of the form $\Gamma \vdash c : A \subtypeA B$, which is formalized by the inference rules presented in Figure~\ref{fig:coercion-typing-rules}.
However, prior to discussing coercion typing, it is necessary to establish the underlying subtyping relation, which we develop in the subsequent section.
