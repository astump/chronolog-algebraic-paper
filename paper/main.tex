...
The language \lcataSub coincides with \lcata, differing only in the elision of the explicit coercion construct, $\sCoerce{c}{a}$, and the introduction of the following typing rule for implicit subtyping.
...
The development of a full type reconstruction mechanism is left to future work.
