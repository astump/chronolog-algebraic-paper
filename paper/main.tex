...
Some notable typing rules of \lcata are presented in Figure~\ref{fig:typing-rules}, and the full set of typing rules is provided in Appendix~\ref{app:typing-rules}
