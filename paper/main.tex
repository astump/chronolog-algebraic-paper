...
This procedure is defined by structural recursion on the term $a$, following the rules formalized in Figure~\ref{fig:constraint-generation-rules}.
Each emitted constraint corresponds to an implied application of the \IRule{Subtype} rule required to construct a valid typing derivation; furthermore, each constraint is implicitly localized to the specific subterm at which subsumption is mandated.
