...
However, the base case coercion typing rules \IRule{ReflDataCoe} and \IRule{RecVarCoe} are each associated merely with the identity coercion \verb|id| (at their respectful types).
...
\begin{theorem}[Equivalence of $\lcata$ and $\lcataSub$]
  $\Gamma \vdash_{\lcata} a : A \iff \Gamma \vdash_{\lcataSub} |a| : A$ and $a \equiv_{\beta \eta} |a|$.
\end{theorem}
