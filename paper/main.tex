...
\begin{lemma}{Termination of \Func{Generate}}
  ...
  For any context $\Gamma$, term $a$, and type $A$, $\Func{Generate}(\Gamma, a, A)$ terminates.
\end{lemma}
\begin{proof}
...
\begin{proof}
  ...
  Then, replace each use of \IRule{Subtype} in this typing derivation with the corresponding derivation of \IRule{Coerce}.
\end{proof}
