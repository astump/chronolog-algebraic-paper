...
correct.  To summarize our contributions:
\begin{itemize}
...
covered. We distinguish applications $c(a)$ of coercions $c$, which
include rolling, unrolling, and catamorphizing.  Coercions will be
...
type $\sFunctorApp{D}{\sRecVar{f}}$, where $D$ is the signature functor of the algebra.
...
the algebra.  The input $n$ has type \verb|Nat R_f|, and so its subdatum
